mix.EM <-
structure(function # Function to mix sample spectres.
### This functions allows to mix grain-size distributions with specified
### proportions and defined noise levels, for example to test the goodness
### of the EMMA algorithm.
(EM,
### Numeric matrix containing the grain-size distribution definitions. Each
### definition is in a separate row with variable contributions in columns.
proportion, 
### Numeric vector containing the relative proportions of each distribution
### per sample.
noise,
### Numeric scalar containing optional relative white noise levels.
autocorrelation
### Numeric scalar specifying the degree of autocorrelation among classes. 
### Autocorrelation is realised as running mean of the specified length. Only 
### odd values are allowed.
  ...
  return(EMs)
  ### Numeric vector comprising a sample composed of known
